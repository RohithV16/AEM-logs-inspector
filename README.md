...
Cloud Manager download and analysis is available for environments where Adobe `aio` and `@adobe/aio-cli-plugin-cloudmanager` are already installed and authenticated outside this app.

To use it:

1. Start the dashboard: `npm run dashboard`
2. Select "Cloud Manager" as your source
3. Choose a program and environment from the live Adobe `aio` data
